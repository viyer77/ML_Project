...
featurePlot(x=trainingData[ , grepl( "belt" , names(trainingData) ) ],y=trainingData$classe,plot="pairs")
featurePlot(x=trainingData[ , grepl( "arm" , names(trainingData) ) ],y=trainingData$classe,plot="pairs")
featurePlot(x=trainingData[ , grepl( "dumbbell" , names(trainingData) ) ],y=trainingData$classe,plot="pairs")
featurePlot(x=trainingData[ , grepl( "forearm" , names(trainingData) ) ],y=trainingData$classe,plot="pairs")
